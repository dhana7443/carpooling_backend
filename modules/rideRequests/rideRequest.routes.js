...
const { sendRideRequest,updateRequestStatus, getRiderRequests, getRideRequestsByRideId,getUnseenRequestCount, markRequestsAsSeen, cancelRideRequest,riderMarkComplete, getRideRequest} = require("./rideRequest.controller");
...
router.get("/driver-info/:requestId",authMiddleware,getRideRequest);
